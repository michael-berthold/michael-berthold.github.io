...
<p align="center">
<img src="{{ '/assets/images/bias_figure1.PNG' | relative_url }}" width="300" alt="Training data.">
<br>
...
<p align="center">
<img src="{{ '/assets/images/bias_figure2.PNG' | relative_url }}" alt="Simple regression line.">
<br>
...
<p align="center">
<img src="{{ '/assets/images/bias_figure3.PNG' | relative_url }}" alt="More complex models.">
<br>
...
<p align="center">
<img src="{{ '/assets/images/bias_figure4.PNG' | relative_url }}" alt="Different fits of the simple line.">
<br>
...
<p align="center">
<img src="{{ '/assets/images/bias_figure5.PNG' | relative_url }}" alt="Model with subset of the data.">
<br>
Figure 4. A different model, trained on only a part of the data.
</p>
